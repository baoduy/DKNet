...
public interface IRepositorySpec
{
    ...
    /// <summary>
    /// Queries entities of type <typeparamref name="TEntity"/> using the provided specification and projects them to <typeparamref name="TModel"/>.
    /// </summary>
    /// <typeparam name="TEntity">The entity type to query.</typeparam>
    ...
    /// </summary>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>A task representing the asynchronous operation that returns the number of state entries written to the database.</returns>
    Task<int> SaveChangesAsync(CancellationToken cancellationToken = default);
}

/// <summary>
/// Implementation of <see cref="IRepositorySpec"/> that provides repository operations using specifications and Entity Framework Core.
/// </summary>
