...
public class SpecificationTests
{
    ...
    [Fact]
    public void And_ShouldReturnAndSpecification()
    {
        // Arrange
        ...
        result.FilterQuery.ShouldNotBeNull();
    }

    [Fact]
    public void Or_ShouldReturnOrSpecification()
    {
        // Arrange
        var spec1 = new TestSpecification();
        spec1.AddTestFilter(u => u.FirstName == "John");
    ...
    [Fact]
    public void BitwiseAndOperator_ShouldReturnAndSpecification()
    {
        // Arrange
        var spec1 = new TestSpecification();
        spec1.AddTestFilter(u => u.FirstName == "John");
    ...
    [Fact]
    public void BitwiseOrOperator_ShouldReturnOrSpecification()
    {
        // Arrange
        var spec1 = new TestSpecification();
        spec1.AddTestFilter(u => u.FirstName == "John");
