...
internal static class AuthConfig
{
    ...
    /// If the <see cref="ValidateMsGraphJwtToken"/> flag is set to true, it replaces the default token handler with a custom <see cref="MsGraphJwtTokenHandler"/>.
    /// </remarks>
    ...
    /// <remarks>
    /// This method enables authentication and authorization middleware only if the authentication configuration has been added to the services.
    /// </remarks>
