...
public static class ServiceCollectionExtensions
{
    ...
    /// <param name="lifetime">The <see cref="ServiceLifetime"/> for the registered services (default is <see cref="ServiceLifetime.Scoped"/>).</param>
    /// <returns>The modified <see cref="IServiceCollection"/>.</returns>
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="services"/> or <paramref name="types"/> is <c>null</c>.</exception>
    ...
    [System.Diagnostics.CodeAnalysis.UnconditionalSuppressMessage("AssemblyLoadTrimming", "IL2072",
        Justification = "Everything referenced in the loaded assembly is manually preserved, so it's safe")]
