...
{
    private static readonly char[] _allowedBase64Chars =
        "ABCDEFGHIJKLMNOPQRSTUVDKNetYZabcdefghijklmnopqrstuvDKNetyz0123456789+/=".ToCharArray();
    ...
    {
        return base64String.All(c => _allowedBase64Chars.Contains(c));
    }
}