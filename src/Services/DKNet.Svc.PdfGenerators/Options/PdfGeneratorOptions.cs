...
public class PdfGeneratorOptions
{
    ...
    /// <summary>
    ///     The title of this document. Can be injected into the header / footer by adding the class <c>document-title</c> to
    ///     the element.
    ///     <value>Default: <see langword="null" />.</value>
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    ///     Html-elements with the classes <c>date</c>, <c>title</c>, <c>document-title</c>, <c>url</c>, <c>pageNumber</c> will
    ///     get their content replaced based on the information.
