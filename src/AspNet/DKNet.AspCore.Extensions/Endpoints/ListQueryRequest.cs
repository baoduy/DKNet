...
public sealed record ListQueryRequest
{
    ...
    /// <summary>Inclusive lower bound on when a record was last active. Replaces the default activity window.</summary>
    [FromQuery(Name = "fromDate")]
    [Description(ListQuery.FromDateDescription)]
    public DateTimeOffset? FromDate { get; init; }

    /// <summary>Inclusive upper bound on when a record was last active. Replaces the default activity window.</summary>
