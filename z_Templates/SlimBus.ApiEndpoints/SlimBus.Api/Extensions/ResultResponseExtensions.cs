...
internal static class ResultResponseExtensions
{
    public static IResult Response<TObject>(this IResult<TObject> result, bool isCreated = false)
    {
        return !result.IsSuccess
            ...
            : result.ValueOrDefault is null ? TypedResults.Ok() : TypedResults.Json(result.Value);
    }

    public static IResult Response(this IResultBase result, bool isCreated = false) => result.IsSuccess
